...
DO $$
BEGIN
    RAISE NOTICE 'Configuration du système d''ingestion terminée avec succès !';
    RAISE NOTICE 'Tables créées: ingestion_audit_log';
    RAISE NOTICE 'Fonctions créées: create_or_get_system_user, log_ingestion_operation';
    RAISE NOTICE 'Utilisateur système configuré pour l''ingestion automatique';
END $$;